...
ApplicationWindow {
    ...
    Material.theme: Material.Dark; Material.accent: "#00E676"
    ...
    Component {
        ...
        ScrollView {
            ...
            ColumnLayout {
                width: window.width; spacing: 20; anchors.margins: 25
                ...
                TextField { id: ein; placeholderText: "EPG XMLTV (.gz)"; Layout.fillWidth: true; color: "white" }
                RowLayout {
                ...
                Button {
                    ...
                    Layout.fillWidth: true; height: 60; highlighted: true
                    onClicked: {
                        var p = "M3U"
    ...
    Component {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle { Layout.fillWidth: true; height: 60; color: "#111111"; Label { anchors.centerIn: parent; text: "КАНАЛЫ ЭФИРА"; font.bold: true } }
                ListView {
                    ...
                    delegate: ItemDelegate {
                        ...
                        onClicked: { selCh = modelData; backend.updateEPG(modelData.id); if (!window.isWide) edrawer.open() }
                    }
                }
            }
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Rectangle { Layout.fillWidth: true; height: 60; color: "#111"; Label { anchors.centerIn: parent; text: "ПРОГРАММА / АРХИВ"; color: "#00E676" } }
                    ListView {
    ...
    Component {
        ...
        Rectangle {
            ...
            Item { anchors.fill: parent; MouseArea { anchors.fill: parent; onClicked: osd.visible = !osd.visible } }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Button { text: "ВЫХОД"; highlighted: true; onClicked: { backend.stop(); stack.pop() } }
